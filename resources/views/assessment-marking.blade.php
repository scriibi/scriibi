...
<div class="row" id="assessment-marking-panel">
    ...
    <div class="marking-panel ml-0 mr-1 px-0 mt-3" id="marking-panel">
        <div class="score-label mx-0 sticky-top bg-white" id="score-label">
            ...
            <div>
                <p class="w-100 text-center lable-input ml-2">{{$rubrics[0]->scriibi_Level}}</p>
            </div>
            <div >
                <p class="w-100 text-center lable-input ml-1">{{$rubrics[1]->scriibi_Level}}</p>
            </div>
                    ...
                    <div class="card-body p-0">
                        <div class="card-title score-items mb-0 radioBTNs-section ml-3">
                            ...
                            @if(!empty($global))
                                ...
                                <div class="w-100 text-center align-self-center">
                                    <label class="score-radio m-0 p-0">
                                        <!-- please load skill id in the name attribute -->
                                        <input class="" type="radio" name="skill_{{$counter}}" value={{$rubrics[2]->scriibi_Level_Id . "/" . $sc->getId()}}><span></span>
                                    </label>
                                </div>
                                <div class="w-100 text-center align-self-center">
                                    <label class="score-radio m-0 p-0">
                        ...
                        <div class="card-text score-items criteria-section hide-up">
                            ...
                            <?php 
                                foreach($global as $g){
                                    if($g != end($global)){
                                        echo '<div class="text-left"><p>'.$g.'</p>
                                        <p class="milestone"></p>
                                        </div><div class="">
                                        </div>';
                                    }else{
