   ...
   <!-- main panel -->
    <div class="col-12 col-sm-10 col-md-8">
        ...
        <div class="accordion card-assessment-style" id="assessmentAccordion">
            ...
            <div class="card collapse show" id="assessment-template">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end mt-4 mb-2">
                        <span data-toggle="collapse show" data-target="#assessment-template" aria-expanded="false" aria-controls="create-assessment-title">
                            <button type="button" name="button" class="btn btn-link assessment-btn border-0" data-toggle="collapse"
                            data-target="#rubric-template" aria-expanded="true" aria-controls="rubric-template">Rubric Selection
                            </button>
                        </span>
                    </div>
                </div>
            ...
            <div class="card collapse" id="rubric-template">
