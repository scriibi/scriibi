...
class CreateGradeLabelsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('grade_label', function (Blueprint $table) {
            ...
            $table->foreign('curriculum_school_type_id', 'fk_grd_lbl_scr_curriculum_school_type')
                ->references('id')
                ->on('curriculum_school_type')
                ->onDelete('no action')
                ->onUpdate('no action');

            $table->foreign('scriibi_level_id', 'fk_grd_lbl_scr_scriibi_level')
                ->references('id')
                ->on('scriibi_level')
                ->onDelete('no action')
                ->onUpdate('no action');
    ...
    {
        Schema::dropIfExists('grade_label');
    }
}
